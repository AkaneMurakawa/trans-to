...
public class YoudaoApi {
    ...
    private static final String APP_KEY = "3871155e1dd7e76e";

    private static final String APP_SECRET = "cYNCwt5uiAkyuv7R0vbAtztlcdKwvncE";
    ...
    public static Object translate(String q) {
        ...
        String json = "";
        try {
            json = requestForHttp(YOUDAO_URL,params);
        } catch (IOException e) {
            e.printStackTrace();
        }
        if ("".equals(json.trim())){
        ...
        if (null != web){
            JSONArray objects = JSONUtil.parseArray(web.toString());
            web = "";
            for (Object object : objects) {
                web += object + "<br/>";
            }
        }
        return translation + "<br/><br/>有道词典-网络释义<br/>" + web;
    }
